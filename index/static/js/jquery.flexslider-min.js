    ...
    d.flexslider = function (i, k) {
        ...
        f = {
            init: function () {
                ...
                setup: function () {
                    ...
                    a.slides.removeClass(e + "myactive-myslide").eq(a.currentItem).addClass(e + "myactive-myslide");
                    a.slides.click(function (b) {
                        b.preventDefault();
                        var b = d(this), g = b.index();
                        !d(c.asNavFor).data("flexslider").animating && !b.hasClass("myactive") && (a.direction = a.currentItem < g ? "next" : "prev", a.flexAnimate(g, c.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                    ...
                    a.controlNavScaffold.delegate("a, img", t, function (b) {
                        ...
                        b.hasClass(e + "myactive") || (a.direction = g > a.currentSlide ? "next" : "prev", a.flexAnimate(g, c.pauseOnAction))
                    });
                    ...
                    a.controlNav.live(t, function (b) {
                        b.preventDefault();
                        var b = d(this), g = a.controlNav.index(b);
                        b.hasClass(e + "myactive") || (g > a.currentSlide ? a.direction = "next" : a.direction = "prev", a.flexAnimate(g, c.pauseOnAction))
                    });
                    ...
                    a.controlNav.removeClass(e + "myactive").eq(a.animatingTo).addClass(e + "myactive")
                }, update: function (b, c) {
        ...
        a.flexAnimate = function (b, g, n, i, k) {
            ...
            if (!a.animating && (a.canAdvance(b, k) || n) && a.is(":visible")) {
                if (s && i)if (n = d(c.asNavFor).data("flexslider"), a.atEnd = 0 === b || b === a.count - 1, n.flexAnimate(b, !0, !1, !0, k), a.direction = a.currentItem < b ? "next" : "prev", n.direction = a.direction, Math.ceil((b + 1) / a.visible) - 1 !== a.currentSlide && 0 !== b)a.currentItem = b, a.slides.removeClass(e + "myactive-myslide").eq(b).addClass(e +
                    "myactive-myslide"), b = Math.floor(b / a.visible); else return a.currentItem = b, a.slides.removeClass(e + "myactive-myslide").eq(b).addClass(e + "myactive-myslide"), !1;
                a.animating = !0;
                a.animatingTo = b;
                c.before(a);
                g && a.pause();
                ...
                h || a.slides.removeClass(e + "myactive-myslide").eq(b).addClass(e + "myactive-myslide");
        ...
        a.setup = function (b) {
            ...
            h || a.slides.removeClass(e + "myactive-myslide").eq(a.currentSlide).addClass(e + "myactive-myslide")
        };
        a.doMath = function () {
