...
(function ($) {
    $.fn.autocomplete = function (params) {
        ...
        this.each(function () {
            ...
            var cancel = $('<div class="cancel Hui-iconfont"></div>').click(function(e){
                input.val('');
                cancel.removeClass('active');
            });

            if (params.showButton) {
                /*input.css('border-radius', '7px 0 0 7px');*/
            }
            ...
            /*input.click(function () {
             $('<span></span>').addClass('abc').text('A B C').css({
             'font-size': '20px', 'color': '#3db1fa', 'position': 'absolute',
             'left': '0px',
             'top': 0,
             'bottom': 0,
             'right': 0,
             ...
             'height': '32px',
             'margin': 'auto',
             }).animate({left:-100},'slow').appendTo(searchContainer);
             });
             */
